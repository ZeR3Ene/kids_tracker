...
<<<<<<< HEAD
        ...
        if (safeZoneData != null &&
            toDouble(safeZoneData['latitude']) != null &&
            toDouble(safeZoneData['longitude']) != null) {
          _safeZone = {
            'latitude': toDouble(safeZoneData['latitude']),
            'longitude': toDouble(safeZoneData['longitude']),
            'radius': toDouble(safeZoneData['radius'] ?? 100.0),
            'color': _color,
          };
        } else if (location != null &&
            toDouble(location['latitude']) != null &&
            toDouble(location['longitude']) != null) {
          _safeZone = {
